...
public enum ParticleEffect {
    ...
    public void broadcast(Location location, float offsetX, float offsetY, float offsetZ, float speed, int amount, @Nullable Entity source, @Nullable Predicate<Player> predicate) {
        PacketPlayOutWorldParticles packet = this.createPacket(location, offsetX, offsetY, offsetZ, speed, amount);
        for (Player player : Bukkit.getOnlinePlayers()) {
