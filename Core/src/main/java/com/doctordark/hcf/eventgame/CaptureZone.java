 ...
 */
public class CaptureZone implements ConfigurationSerializable, Mongoable{

    public static final int MINIMUM_SIZE_AREA = 2;

    private final Object lock = new Object();
    private String scoreboardRemaining = "00:00";
    private String name;
    ...
    public CaptureZone(Document document){
        ...
        if(document.containsKey("cuboid")){
            cuboid = new Cuboid((Document) document.get("cuboid"));
        }

        defaultCaptureMillis = Long.valueOf(document.getString("captureMillis"));
    }
    ...
    public Document toDocument(){
        ...
        if(cuboid != null){
            document.put("cuboid", cuboid.toDocument());
        }

        document.put("captureMillis", Long.toString(defaultCaptureMillis));
        return document;
    }
    ...
    public long getRemainingCaptureMillis(){
        ...
        }else if(endMillis == Long.MIN_VALUE){
            return -1L;
    ...
    public void setRestoreMillis(long millis){
        this.restoreMillis = millis;
    }
    ...
    public void setCappingPlayer(@Nullable Player player){
        ...
        }else if(restoreMillis > 0){
            endMillis = System.currentTimeMillis() + restoreMillis;
            restoreMillis = 0L;
        }else{
