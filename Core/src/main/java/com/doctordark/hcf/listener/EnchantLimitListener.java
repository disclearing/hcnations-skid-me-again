...
public class EnchantLimitListener implements Listener{
    ...
    public void onEntityDeath(EntityDeathEvent event){
        if(!(event.getEntity() instanceof Player)){
            event.getDrops().forEach(this::validateIllegalEnchants);
        }
    }
     ...
     */
    private boolean validateIllegalEnchants(ItemStack stack){//TODO Add a way to bypass for items from crates/loot (Ex. "Loot" in the lore
