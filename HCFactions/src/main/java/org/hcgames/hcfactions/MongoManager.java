...
public class MongoManager {
    ...
    MongoManager(HCFactions plugin){
        plugin.getLogger().info("==========================");
        plugin.getLogger().info("Connecting to Mongo");
        ...
        //collectionPrefix = (plugin.getConfiguration().isKitMap() ? "kitmap" : "map") + plugin.getConfiguration().getMapNumber() + "-";
        collectionPrefix = "";
    }
